...
class PointCloudVisualizer():
    ...
    def pointclouds_callback(self, msg):
        self.node.get_logger().info("In pointcloud ")
        self.node.get_logger().info("Recieved msg " + str(msg) + " inpointclouds.")
    ...
    def keyframe_pointcloud_to_pose_pointcloud(self):
        ...
        for robot_id, sensor_data in self.pointclouds.items():
            self.node.get_logger().info("In keyframe pointcloud to pose robbot graphs are " + str(self.pose_graph_viz.robot_pose_graphs))
